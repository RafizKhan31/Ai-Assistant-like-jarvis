...
def speak(text):
    try:
        ...
        faster = sound.speedup(playback_speed=1.1)
    ...
    try:
        ...
        completion = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are J.A.R.V.I.S., a calm, polite, witty AI assistant. Give a single, short, helpful, and intelligent response. Do not ask questions or offer to continue. Act exactly like J.A.R.V.I.S. would."
                },
                {
                    "role": "user",
                    "content": command
...
def processCommand(c):
    try:
        ...
        # check if user is repeating Jarvis
        if command == "jarvis":
...
if __name__ == "__main__":
    ...
    print("             Created by Md Rafej Khan")
    print("=" * 55)

    speak("Initializing Jarvis. Created by Md Rafej Khan.")
